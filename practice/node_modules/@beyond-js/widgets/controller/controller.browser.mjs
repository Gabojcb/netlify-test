...
const __pkg = new __Bundle({"module":{"vspecifier":"@beyond-js/widgets@0.1.5/controller"},"type":"ts"}, import.meta.url).package();;
...
ims.set('./controller', {hash: 3835813087, creator: function (require, exports) {
"use strict";
